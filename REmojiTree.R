...
if ( treetype == "Plant" ) {
  ...
  generate_tree <- function(emoji_type) {
    if (emoji_type == "Twitter") {
      nwk <- paste0("(potted-plant, ((evergreen-tree, christmas-tree),(avocado,((tulip, ((hyacinth, (garlic, onion)), ((palm-tree, coconut), ((banana, ginger), (pineapple, (ear-of-corn, (tanabata-tree, sheaf-of-rice))))))),(lotus,((grapes, ((((peanuts, (beans, pea-pod)), (shamrock, four-leaf-clover)), (((rose, strawberry), (((red-apple, green-apple), pear), (peach, (cherry-blossom, cherries)))), (chestnut, (jack-o-lantern, (watermelon, (cucumber, melon)))))), (((hibiscus, chocolate-bar), broccoli), ((mango, ((tangerine, lemon), (maple-leaf))))))),(cactus, ((teacup-without-handle, (kiwi-fruit, blueberries)), ((olive, hot-beverage,(roasted-sweet-potato,(cigarette, ((hot-pepper, bell-pepper), (eggplant, (potato, tomato)))))), (carrot, (leafy-green, (sunflower, blossom))))))))))));")
    } else if (emoji_type == "WhatsApp") {
      nwk <- paste0("((evergreen-tree, christmas-tree),(avocado,(((potted-plant, (tulip, ((hyacinth, (garlic, onion)), ((palm-tree, coconut), ((banana, ginger), (pineapple, (ear-of-corn, (tanabata-tree, sheaf-of-rice))))))))),(lotus, ((grapes, ((((peanuts, (beans, pea-pod)), (shamrock, four-leaf-clover)), (((rose, strawberry), (((red-apple, green-apple), pear), (peach, (cherry-blossom, cherries)))), (chestnut, (jack-o-lantern, (watermelon, (cucumber, melon)))))), (((hibiscus, chocolate-bar), broccoli), ((mango, ((tangerine, lemon), (maple-leaf))))))),(cactus, ((teacup-without-handle, (kiwi-fruit, blueberries)), ((olive, hot-beverage,(roasted-sweet-potato,(cigarette, ((hot-pepper, bell-pepper), (eggplant, (potato, tomato)))))), (carrot, (leafy-green, (sunflower, blossom)))))))))));")
    } else if (emoji_type == "Apple") {
      nwk <- paste0("((evergreen-tree, christmas-tree),(avocado,(((tulip, ((hyacinth, (garlic, onion)), ((palm-tree, coconut), ((banana, ginger), (pineapple, (ear-of-corn, (tanabata-tree, sheaf-of-rice)))))))),(lotus, ((grapes, ((((peanuts, (beans, pea-pod)), (shamrock, four-leaf-clover)), (((rose, strawberry), (((red-apple, green-apple), pear), (peach, (cherry-blossom, cherries)))), (chestnut, (jack-o-lantern, (watermelon, (cucumber, melon)))))), (((hibiscus, chocolate-bar), (broccoli, leafy-green)), ((mango, ((tangerine, lemon), (maple-leaf))))))),(cactus, ((teacup-without-handle, (kiwi-fruit, blueberries)), ((olive, hot-beverage,(roasted-sweet-potato,(cigarette, ((hot-pepper, bell-pepper), (eggplant, (potato, tomato)))))), (carrot, (sunflower, blossom))))))))));")
  ...
  p <- ggtree(tree, layout = "circular") +
    geom_tiplab2(aes(image=paste0(imgdir, '/', label, '.png')), geom="image", offset=3, align = T, size=.05)
  ...
  nwk <- paste0("((coral, jellyfish), (((((octopus, squid), (oyster, (snail, spiral-shell))), worm), ((spider, scorpion), ((shrimp, (crab, lobster)), ((cricket, cockroach), ((honeybee, ant), (((beetle, lady-beetle), (butterfly, (mosquito, fly))))))))),
              (shark,((fish, tropical-fish, blowfish), (frog, ((((snake, lizard), (turtle, ((sauropod, (t-rex, ((((rooster, peacock), turkey), ((goose, swan ), duck)), (flamingo, ((dove, dodo), (penguin, (owl, eagle, parrot))))))), crocodile))),
  ...
  tree = read.tree(text = nwk)
  p <- ggtree(tree, layout = "circular") +
    geom_tiplab2(aes(image=paste0(imgdir, '/', label, '.png')), geom="image", offset=3, align = T, size=.025)
  ...
  generate_tree <- function(emoji_type) {
    if (emoji_type == "Twitter") {
      nwk <- paste0("(microbe, ((potted-plant, ((evergreen-tree, christmas-tree),(avocado,((tulip, ((hyacinth, (garlic, onion)), ((palm-tree, coconut), ((banana, ginger), (pineapple, (ear-of-corn, (tanabata-tree, sheaf-of-rice))))))),(lotus, ((grapes, ((((peanuts, (beans, pea-pod)), (shamrock, four-leaf-clover)), (((rose, strawberry), (((red-apple, green-apple), pear), (peach, (cherry-blossom, cherries)))), (chestnut, (jack-o-lantern, (watermelon, (cucumber, melon)))))), (((hibiscus, chocolate-bar), broccoli), ((mango, ((tangerine, lemon), (maple-leaf))))))),(cactus, ((teacup-without-handle, (kiwi-fruit, blueberries)), ((olive, hot-beverage,(roasted-sweet-potato,(cigarette, ((hot-pepper, bell-pepper), (eggplant, (potato, tomato)))))), (carrot, (leafy-green, (sunflower, blossom)))))))))))), 
      ...
      nwk <- paste0("(microbe, (((evergreen-tree, christmas-tree),(avocado,(((potted-plant, (tulip, ((hyacinth, (garlic, onion)), ((palm-tree, coconut), ((banana, ginger), (pineapple, (ear-of-corn, (tanabata-tree, sheaf-of-rice))))))))),(lotus, ((grapes, ((((peanuts, (beans, pea-pod)), (shamrock, four-leaf-clover)), (((rose, strawberry), (((red-apple, green-apple), pear), (peach, (cherry-blossom, cherries)))), (chestnut, (jack-o-lantern, (watermelon, (cucumber, melon)))))), (((hibiscus, chocolate-bar), broccoli), ((mango, ((tangerine, lemon), (maple-leaf))))))),(cactus, ((teacup-without-handle, (kiwi-fruit, blueberries)), ((olive, hot-beverage,(roasted-sweet-potato,(cigarette, ((hot-pepper, bell-pepper), (eggplant, (potato, tomato)))))), (carrot, (leafy-green, (sunflower, blossom))))))))))), 
              (mushroom, ((coral, jellyfish), (((((octopus, squid), (oyster, (snail, spiral-shell))), worm), ((spider, scorpion), ((shrimp, (crab, lobster)), ((cricket, cockroach), ((honeybee, ant), (((beetle, lady-beetle), (butterfly, (mosquito, fly))))))))),
              (shark,((fish, tropical-fish, blowfish), (frog, ((((snake, lizard), (turtle, ((sauropod, (t-rex, ((((rooster, peacock), turkey), ((goose, swan ), duck)), (flamingo, ((dove, dodo), (penguin, (owl, eagle, parrot))))))), crocodile))),
              ((kangaroo, koala), ((((elephant, mammoth)),sloth), ((hedgehog, (bat, (((((camel, two-hump-camel), llama), ((boar, pig), ((giraffe, ((deer, moose), ((ewe, goat), (water-buffalo, (bison, (ox, cow)))))), (hippopotamus, (dolphin, spouting-whale))))), ((horse, zebra), rhinoceros)),
              (((tiger, (lion, leopard)), cat), (((dog, wolf), fox), (((bear, polar-bear), panda), (seal, (skunk, (raccoon, (badger, otter)))))))))),
      ...
      nwk <- paste0("(microbe, (((evergreen-tree, christmas-tree),(avocado,(((tulip, ((hyacinth, (garlic, onion)), ((palm-tree, coconut), ((banana, ginger), (pineapple, (ear-of-corn, (tanabata-tree, sheaf-of-rice)))))))),(lotus, ((grapes, ((((peanuts, (beans, pea-pod)), (shamrock, four-leaf-clover)), (((rose, strawberry), (((red-apple, green-apple), pear), (peach, (cherry-blossom, cherries)))), (chestnut, (jack-o-lantern, (watermelon, (cucumber, melon)))))), (((hibiscus, chocolate-bar), (broccoli, leafy-green)), ((mango, ((tangerine, lemon), (maple-leaf))))))),(cactus, ((teacup-without-handle, (kiwi-fruit, blueberries)), ((olive, hot-beverage,(roasted-sweet-potato,(cigarette, ((hot-pepper, bell-pepper), (eggplant, (potato, tomato)))))), (carrot, (sunflower, blossom)))))))))), 
              (mushroom, ((coral, jellyfish), (((((octopus, squid), (oyster, (snail, spiral-shell))), worm), ((spider, scorpion), ((shrimp, (crab, lobster)), ((cricket, cockroach), ((honeybee, ant), (((beetle, lady-beetle), (butterfly, (mosquito, fly))))))))),
              (shark,((fish, tropical-fish, blowfish), (frog, ((((snake, lizard), (turtle, ((sauropod, (t-rex, ((((rooster, peacock), turkey), ((goose, swan ), duck)), (flamingo, ((dove, dodo), (penguin, (owl, eagle, parrot))))))), crocodile))),
              ((kangaroo, koala), ((((elephant, mammoth)),sloth), ((hedgehog, (bat, (((((camel, two-hump-camel), llama), ((boar, pig), ((giraffe, ((deer, moose), ((ewe, goat), (water-buffalo, (bison, (ox, cow)))))), (hippopotamus, (dolphin, spouting-whale))))), ((horse, zebra), rhinoceros)),
              (((tiger, (lion, leopard)), cat), (((dog, wolf), fox), (((bear, polar-bear), panda), (seal, (skunk, (raccoon, (badger, otter)))))))))),
  ...
  tree = read.tree(text = nwk)
  p <- ggtree(tree, layout = "circular") +
    geom_tiplab2(aes(image=paste0(imgdir, '/', label, '.png')), geom="image", offset=3, align = T, size=.018)
