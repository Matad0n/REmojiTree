...
imgdir <- c("C:/")
#Select type of emoji you want ("Apple", "Twitter", "Facebook", "Google", "WhatsApp", "Microsoft", "Samsung")
emoji_type = "Twitter"
...
url_patterns <- list(
  ...
  Microsoft = "https://em-content.zobj.net/source/microsoft/319/",
...
nwk <- paste0("((evergreen-tree, christmas-tree),((avocado, lotus),((tulip, ((hyacinth, (garlic, onion)), ((palm-tree, coconut), ((banana, ginger), (pineapple, (ear-of-corn, (tanabata-tree, sheaf-of-rice))))))),((grapes, ((((peanuts, (beans, pea-pod)), (shamrock, four-leaf-clover)), (((rose, strawberry), (((red-apple, green-apple), pear), (peach, (cherry-blossom, cherries)))), (chestnut, (jack-o-lantern, (watermelon, (cucumber, melon)))))), (((hibiscus, chocolate-bar), broccoli), ((mango, ((tangerine, lemon), (maple-leaf))))))),(cactus, ((kiwi-fruit, blueberries), ((olive,(roasted-sweet-potato,(cigarette, ((hot-pepper, bell-pepper), (eggplant, (potato, tomato)))))), (carrot,(leafy-green, (sunflower, blossom))))))))));")
